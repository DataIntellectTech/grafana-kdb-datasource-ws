![AquaQ Analytics](https://github.com/AquaQAnalytics/grafana-kdb-datasource-ws/blob/master/images/aquaq_bubbles_grafana.png)
...
- Launch your browser (see **Supported Browsers**) then use the following URL to open Grafana: *http://localhost:8080/* and sign in using Usr:`admin` Pwd:`admin` (You will be prompted for changing password. *Skip*.)
