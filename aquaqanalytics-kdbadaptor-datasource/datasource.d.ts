...
export declare class KDBDatasource {
    ...
    private fieldInjectVariables(attrib, search, replace);
    ...
    metricFindQueryDefault(kdbRequest: KdbRequest): Promise<{}>;
    metricFindQuerySym(kdbRequest: KdbRequest): Promise<{}>;
