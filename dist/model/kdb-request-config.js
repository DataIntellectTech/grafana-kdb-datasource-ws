    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("graphFunction", graphFunction = '{@[x;y;{`payload`error`success!(();"Error! - ",x;0b)}]}{[dict] \n ' +
                ...
                ' }');
            //Table response type
            exports_1("tabFunction", tabFunction = '{@[x;y;{`payload`error`success!(();"Error! - ",x;0b)}]}{[dict] \n ' +
                ' \n ' +
                ' \n ' +
                ' conc:{ \n ' +
                ...
                ' } \n ' +
                '');
            exports_1("argCounter", argCounter = 'argcount:{v:value x;$[100h=t:type x;count v 1; \n ' +
...
//# sourceMappingURL=kdb-request-config.js.map