...
.z.ts:{
  s:n?syms;
  $[0<flag mod 10;
  h(`upd;`dummyquote;(n#.z.d+.z.T;s;getbid'[s];getask'[s]));  /* This and the line below were originally .z.N */
  h(`upd;`dummytrade;(n#.z.d+.z.T;s;getprice'[s];n?1000))     /*2020-16-01 original date*/
  ];
  flag+:1;
 };
